    ...
    <div class="space-y-6 p-6 sm:p-8">
        ...
        <div class="grid gap-3 sm:grid-cols-3">
            ...
            <div class="rounded-xl border border-neutral-200 bg-zinc-50 px-4 py-3 dark:border-neutral-700 dark:bg-zinc-950">
                ...
                <div class="mt-1 text-[11px] text-zinc-500 dark:text-zinc-400">{{ __('Two fields required — Pitch 1 & Pitch 2 order follows sort order.') }}</div>
            </div>
            <div class="rounded-xl border border-neutral-200 bg-zinc-50 px-4 py-3 dark:border-neutral-700 dark:bg-zinc-950">
        ...
        <div class="overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700">
            ...
            <div class="overflow-x-auto">
                ...
                @foreach ($smallDayOneGridRows as $row)
                    @php
                        $p1 = $row['pitch1_match'];
                        $p2 = $row['pitch2_match'];
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div class="min-w-0">
                ...
                <p class="mt-2 max-w-3xl text-sm text-zinc-600 dark:text-zinc-300">
                    {{ __('Twelve time slots on Pitch 1 and Pitch 2 (24 games). Pairings follow Berger round-robin order using teams sorted by seed. Sync writes rows to the matches table so you can edit status and scores like other round robin games.') }}
                </p>
