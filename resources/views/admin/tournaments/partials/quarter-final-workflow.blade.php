@php
    ...
    $poolingData = TournamentPooling::buildPoolingAssignments($selectedTournament, $crossoverMatches);
    $poolingReadyForQuarterFinals = TournamentPooling::poolingFinalizedForQuarterFinalGeneration($poolingData);

    $qfMatches = collect($selectedTournament->matches ?? [])
        ->filter(fn ($match): bool => $match->stage === 'quarterfinal')
    ...
    <section class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-zinc-900">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
            ...
            >
                ...
                <flux:button type="submit" variant="primary" :disabled="! $poolingReadyForQuarterFinals">
